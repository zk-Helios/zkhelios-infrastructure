      ...
      <Reveal>
        <div className="relative overflow-hidden rounded-2xl border border-amber-500/20 bg-ink-800 px-6 py-16 text-center md:px-16 md:py-20">
          ...
          <div className="relative z-10 mx-auto flex max-w-2xl flex-col items-center">
            ...
            <h2 className="mt-8 font-display text-h2 font-bold text-paper [text-wrap:balance]">
              Step into the light.
            </h2>
            <p className="mt-4 text-lead text-paper-muted [text-wrap:balance]">
              Launch the app to bridge assets and generate your first zero-knowledge proof — or
              join the newsletter for protocol updates.
            </p>
